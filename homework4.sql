...
--
-- Хост: localhost
-- Время создания: Ноя 13 2013 г., 09:49
...
--
-- Структура таблицы `jykap_assets`
--

CREATE TABLE IF NOT EXISTS `jykap_assets` (
...
--
-- Дамп данных таблицы `jykap_assets`
--

INSERT INTO `jykap_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
(35, 27, 19, 20, 3, 'com_content.article.1', 'Test 1', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}'),
(36, 27, 21, 22, 3, 'com_content.article.2', 'Test 2', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}');

-- --------------------------------------------------------

--
-- Структура таблицы `jykap_associations`
--

CREATE TABLE IF NOT EXISTS `jykap_associations` (
...
--
-- Структура таблицы `jykap_banners`
--

CREATE TABLE IF NOT EXISTS `jykap_banners` (
...
--
-- Структура таблицы `jykap_banner_clients`
--

CREATE TABLE IF NOT EXISTS `jykap_banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Структура таблицы `jykap_banner_tracks`
--

CREATE TABLE IF NOT EXISTS `jykap_banner_tracks` (
...
--
-- Структура таблицы `jykap_categories`
--

CREATE TABLE IF NOT EXISTS `jykap_categories` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Дамп данных таблицы `jykap_categories`
--

INSERT INTO `jykap_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`) VALUES
...
--
-- Структура таблицы `jykap_contact_details`
--

CREATE TABLE IF NOT EXISTS `jykap_contact_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Структура таблицы `jykap_content`
--

CREATE TABLE IF NOT EXISTS `jykap_content` (
...
--
-- Дамп данных таблицы `jykap_content`
--

INSERT INTO `jykap_content` (`id`, `asset_id`, `title`, `alias`, `title_alias`, `introtext`, `fulltext`, `state`, `sectionid`, `mask`, `catid`, `created`, `created_by`, `created_by_alias`, `modified`, `modified_by`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `images`, `urls`, `attribs`, `version`, `parentid`, `ordering`, `metakey`, `metadesc`, `access`, `hits`, `metadata`, `featured`, `language`, `xreference`) VALUES
(1, 35, 'Test 1', 'test-1', '', '<p>Test 1Test 1Test 1Test 1</p>', '', 1, 0, 0, 2, '2013-11-13 07:35:41', 467, '', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', '2013-11-13 07:35:41', '0000-00-00 00:00:00', '{"image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '{"urla":false,"urlatext":"","targeta":"","urlb":false,"urlbtext":"","targetb":"","urlc":false,"urlctext":"","targetc":""}', '{"show_title":"","link_titles":"","show_intro":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_vote":"","show_hits":"","show_noauth":"","urls_position":"","alternative_readmore":"","article_layout":"","show_publishing_options":"","show_article_options":"","show_urls_images_backend":"","show_urls_images_frontend":""}', 1, 0, 1, '', '', 1, 0, '{"robots":"","author":"","rights":"","xreference":""}', 0, '*', ''),
(2, 36, 'Test 2', 'test-2', '', '<p>Test 2Test 2Test 2Test 2Test 2</p>', '', 1, 0, 0, 2, '2013-11-13 07:35:51', 467, '', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', '2013-11-13 07:35:51', '0000-00-00 00:00:00', '{"image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '{"urla":false,"urlatext":"","targeta":"","urlb":false,"urlbtext":"","targetb":"","urlc":false,"urlctext":"","targetc":""}', '{"show_title":"","link_titles":"","show_intro":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_vote":"","show_hits":"","show_noauth":"","urls_position":"","alternative_readmore":"","article_layout":"","show_publishing_options":"","show_article_options":"","show_urls_images_backend":"","show_urls_images_frontend":""}', 1, 0, 0, '', '', 1, 0, '{"robots":"","author":"","rights":"","xreference":""}', 0, '*', '');

-- --------------------------------------------------------

--
-- Структура таблицы `jykap_content_frontpage`
--

CREATE TABLE IF NOT EXISTS `jykap_content_frontpage` (
...
--
-- Структура таблицы `jykap_content_rating`
--

CREATE TABLE IF NOT EXISTS `jykap_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Структура таблицы `jykap_core_log_searches`
--

CREATE TABLE IF NOT EXISTS `jykap_core_log_searches` (
...
--
-- Структура таблицы `jykap_extensions`
--

CREATE TABLE IF NOT EXISTS `jykap_extensions` (
...
--
-- Дамп данных таблицы `jykap_extensions`
--

INSERT INTO `jykap_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(10000, 'testmodule', 'module', 'articlelist_module', '', 0, 1, 0, 0, '{"legacy":true,"name":"testmodule","type":"module","creationDate":"Unknown","author":"Gudkov Sergey","copyright":"","authorEmail":"","authorUrl":"","version":"1.0","description":"Article list module","group":""}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10001, 'Article list module', 'module', 'article_list_module', '', 0, 1, 0, 0, '{"legacy":true,"name":"Article list module","type":"module","creationDate":"Unknown","author":"Gudkov Sergey","copyright":"","authorEmail":"","authorUrl":"","version":"1.0","description":"Article list module","group":""}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10002, 'My article list module', 'module', 'mod_articlelist', '', 0, 1, 0, 0, '{"legacy":true,"name":"My article list module","type":"module","creationDate":"Unknown","author":"Gudkov Sergey","copyright":"","authorEmail":"","authorUrl":"","version":"1.0","description":"Article list module","group":""}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0);

-- --------------------------------------------------------

--
-- Структура таблицы `jykap_finder_filters`
--

CREATE TABLE IF NOT EXISTS `jykap_finder_filters` (
...
--
-- Структура таблицы `jykap_finder_links`
--

CREATE TABLE IF NOT EXISTS `jykap_finder_links` (
...
--
-- Структура таблицы `jykap_finder_links_terms0`
--

CREATE TABLE IF NOT EXISTS `jykap_finder_links_terms0` (
...
--
-- Структура таблицы `jykap_finder_links_terms1`
--

CREATE TABLE IF NOT EXISTS `jykap_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `jykap_finder_links_terms2`
--

CREATE TABLE IF NOT EXISTS `jykap_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `jykap_finder_links_terms3`
--

CREATE TABLE IF NOT EXISTS `jykap_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `jykap_finder_links_terms4`
--

CREATE TABLE IF NOT EXISTS `jykap_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `jykap_finder_links_terms5`
--

CREATE TABLE IF NOT EXISTS `jykap_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `jykap_finder_links_terms6`
--

CREATE TABLE IF NOT EXISTS `jykap_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `jykap_finder_links_terms7`
--

CREATE TABLE IF NOT EXISTS `jykap_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `jykap_finder_links_terms8`
--

CREATE TABLE IF NOT EXISTS `jykap_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `jykap_finder_links_terms9`
--

CREATE TABLE IF NOT EXISTS `jykap_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `jykap_finder_links_termsa`
--

CREATE TABLE IF NOT EXISTS `jykap_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `jykap_finder_links_termsb`
--

CREATE TABLE IF NOT EXISTS `jykap_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `jykap_finder_links_termsc`
--

CREATE TABLE IF NOT EXISTS `jykap_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `jykap_finder_links_termsd`
--

CREATE TABLE IF NOT EXISTS `jykap_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `jykap_finder_links_termse`
--

CREATE TABLE IF NOT EXISTS `jykap_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `jykap_finder_links_termsf`
--

CREATE TABLE IF NOT EXISTS `jykap_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Структура таблицы `jykap_finder_taxonomy`
--

CREATE TABLE IF NOT EXISTS `jykap_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Дамп данных таблицы `jykap_finder_taxonomy`
--

INSERT INTO `jykap_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Структура таблицы `jykap_finder_taxonomy_map`
--

CREATE TABLE IF NOT EXISTS `jykap_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Структура таблицы `jykap_finder_terms`
--

CREATE TABLE IF NOT EXISTS `jykap_finder_terms` (
...
--
-- Структура таблицы `jykap_finder_terms_common`
--

CREATE TABLE IF NOT EXISTS `jykap_finder_terms_common` (
  `term` varchar(75) NOT NULL,
...
--
-- Дамп данных таблицы `jykap_finder_terms_common`
--

INSERT INTO `jykap_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Структура таблицы `jykap_finder_tokens`
--

CREATE TABLE IF NOT EXISTS `jykap_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Структура таблицы `jykap_finder_tokens_aggregate`
--

CREATE TABLE IF NOT EXISTS `jykap_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Структура таблицы `jykap_finder_types`
--

CREATE TABLE IF NOT EXISTS `jykap_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Структура таблицы `jykap_languages`
--

CREATE TABLE IF NOT EXISTS `jykap_languages` (
...
--
-- Дамп данных таблицы `jykap_languages`
--

INSERT INTO `jykap_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en', '', '', '', '', 1, 0, 1);

-- --------------------------------------------------------

--
-- Структура таблицы `jykap_menu`
--

CREATE TABLE IF NOT EXISTS `jykap_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Дамп данных таблицы `jykap_menu`
--

INSERT INTO `jykap_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `ordering`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
--
-- Структура таблицы `jykap_menu_types`
--

CREATE TABLE IF NOT EXISTS `jykap_menu_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Дамп данных таблицы `jykap_menu_types`
--

INSERT INTO `jykap_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
(1, 'mainmenu', 'Main Menu', 'The main menu for the site');

-- --------------------------------------------------------

--
-- Структура таблицы `jykap_messages`
--

CREATE TABLE IF NOT EXISTS `jykap_messages` (
...
--
-- Структура таблицы `jykap_messages_cfg`
--

CREATE TABLE IF NOT EXISTS `jykap_messages_cfg` (
...
--
-- Структура таблицы `jykap_modules`
--

CREATE TABLE IF NOT EXISTS `jykap_modules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Дамп данных таблицы `jykap_modules`
--

INSERT INTO `jykap_modules` (`id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
(87, 'testmodule', '', '', 0, '', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', -2, 'articlelist_module', 1, 1, '', 0, '*'),
(88, 'Article list module', '', '', 1, 'position-7', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', -2, 'article_list_module', 1, 1, '', 0, '*'),
(89, 'Test 1', '', '<p>Test!!!</p>', 1, 'position-7', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', -2, 'mod_custom', 1, 1, '{"prepare_content":"0","backgroundimage":"","layout":"_:default","moduleclass_sfx":"","cache":"1","cache_time":"900","cachemode":"static"}', 0, '*'),
(90, 'My article list module', '', '', 1, 'position-7', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_articlelist', 1, 1, '', 0, '*');

-- --------------------------------------------------------

--
-- Структура таблицы `jykap_modules_menu`
--

CREATE TABLE IF NOT EXISTS `jykap_modules_menu` (
...
--
-- Дамп данных таблицы `jykap_modules_menu`
--

INSERT INTO `jykap_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Структура таблицы `jykap_newsfeeds`
--

CREATE TABLE IF NOT EXISTS `jykap_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Структура таблицы `jykap_overrider`
--

CREATE TABLE IF NOT EXISTS `jykap_overrider` (
...
--
-- Структура таблицы `jykap_redirect_links`
--

CREATE TABLE IF NOT EXISTS `jykap_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Структура таблицы `jykap_schemas`
--

CREATE TABLE IF NOT EXISTS `jykap_schemas` (
...
--
-- Дамп данных таблицы `jykap_schemas`
--

INSERT INTO `jykap_schemas` (`extension_id`, `version_id`) VALUES
(700, '2.5.14');

-- --------------------------------------------------------

--
-- Структура таблицы `jykap_session`
--

CREATE TABLE IF NOT EXISTS `jykap_session` (
...
--
-- Дамп данных таблицы `jykap_session`
--

INSERT INTO `jykap_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`, `usertype`) VALUES
('070b9348786b2189d2fe2df7f39cabcc', 0, 1, '1384328940', '__default|a:8:{s:22:"session.client.browser";s:104:"Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.31 (KHTML, like Gecko) Chrome/26.0.1410.63 Safari/537.31";s:15:"session.counter";i:16;s:8:"registry";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":0:{}}s:4:"user";O:5:"JUser":25:{s:9:"\0*\0isRoot";b:0;s:2:"id";i:0;s:4:"name";N;s:8:"username";N;s:5:"email";N;s:8:"password";N;s:14:"password_clear";s:0:"";s:8:"usertype";N;s:5:"block";N;s:9:"sendEmail";i:0;s:12:"registerDate";N;s:13:"lastvisitDate";N;s:10:"activation";N;s:6:"params";N;s:6:"groups";a:0:{}s:5:"guest";i:1;s:13:"lastResetTime";N;s:10:"resetCount";N;s:10:"\0*\0_params";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":0:{}}s:14:"\0*\0_authGroups";a:1:{i:0;i:1;}s:14:"\0*\0_authLevels";a:2:{i:0;i:1;i:1;i:1;}s:15:"\0*\0_authActions";N;s:12:"\0*\0_errorMsg";N;s:10:"\0*\0_errors";a:0:{}s:3:"aid";i:0;}s:13:"session.token";s:32:"35f9b9aaffd7bd29d397e9d4f87c85f6";s:19:"session.timer.start";i:1384328018;s:18:"session.timer.last";i:1384328641;s:17:"session.timer.now";i:1384328940;}', 0, '', ''),
('1eno67a4pnbs64490aungrh340', 1, 0, '1384328954', '__default|a:8:{s:15:"session.counter";i:17;s:19:"session.timer.start";i:1384327834;s:18:"session.timer.last";i:1384328951;s:17:"session.timer.now";i:1384328954;s:22:"session.client.browser";s:104:"Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.31 (KHTML, like Gecko) Chrome/26.0.1410.63 Safari/537.31";s:8:"registry";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":5:{s:11:"application";O:8:"stdClass":1:{s:4:"lang";s:0:"";}s:13:"com_installer";O:8:"stdClass":2:{s:7:"message";s:0:"";s:17:"extension_message";s:0:"";}s:9:"com_cache";O:8:"stdClass":1:{s:5:"cache";O:8:"stdClass":1:{s:8:"ordercol";s:5:"group";}}s:11:"com_modules";O:8:"stdClass":1:{s:7:"modules";O:8:"stdClass":1:{s:6:"filter";O:8:"stdClass":1:{s:18:"client_id_previous";i:0;}}}s:11:"com_content";O:8:"stdClass":1:{s:4:"edit";O:8:"stdClass":1:{s:7:"article";O:8:"stdClass":1:{s:4:"data";N;}}}}}s:4:"user";O:5:"JUser":25:{s:9:"\0*\0isRoot";b:1;s:2:"id";s:3:"467";s:4:"name";s:10:"Super User";s:8:"username";s:5:"admin";s:5:"email";s:23:"homework4@homework4.com";s:8:"password";s:65:"af124dea302109c5fa314b1d297584ff:KlQzlSmrplRrwgzycj7VbOFxxk8sXdnb";s:14:"password_clear";s:0:"";s:8:"usertype";s:10:"deprecated";s:5:"block";s:1:"0";s:9:"sendEmail";s:1:"1";s:12:"registerDate";s:19:"2013-11-11 09:15:36";s:13:"lastvisitDate";s:19:"2013-11-11 13:08:00";s:10:"activation";s:1:"0";s:6:"params";s:0:"";s:6:"groups";a:1:{i:8;s:1:"8";}s:5:"guest";i:0;s:13:"lastResetTime";s:19:"0000-00-00 00:00:00";s:10:"resetCount";s:1:"0";s:10:"\0*\0_params";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":0:{}}s:14:"\0*\0_authGroups";a:2:{i:0;i:1;i:1;i:8;}s:14:"\0*\0_authLevels";a:4:{i:0;i:1;i:1;i:1;i:2;i:2;i:3;i:3;}s:15:"\0*\0_authActions";N;s:12:"\0*\0_errorMsg";N;s:10:"\0*\0_errors";a:0:{}s:3:"aid";i:0;}s:13:"session.token";s:32:"62dd08548e2bcd920ab27590ad70ca6d";}', 467, 'admin', '');

-- --------------------------------------------------------

--
-- Структура таблицы `jykap_template_styles`
--

CREATE TABLE IF NOT EXISTS `jykap_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Дамп данных таблицы `jykap_template_styles`
--

INSERT INTO `jykap_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
--
-- Структура таблицы `jykap_updates`
--

CREATE TABLE IF NOT EXISTS `jykap_updates` (
...
--
-- Дамп данных таблицы `jykap_updates`
--

INSERT INTO `jykap_updates` (`update_id`, `update_site_id`, `extension_id`, `categoryid`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`) VALUES
...
(16, 3, 0, 0, 'Slovak', '', 'pkg_sk-SK', 'package', '', 0, '2.5.15.1', '', 'http://update.joomla.org/language/details/sk-SK_details.xml', ''),
(17, 3, 0, 0, 'Belarusian', '', 'pkg_be-BY', 'package', '', 0, '2.5.8.1', '', 'http://update.joomla.org/language/details/be-BY_details.xml', ''),
(18, 3, 0, 0, 'Latvian', '', 'pkg_lv-LV', 'package', '', 0, '2.5.16.1', '', 'http://update.joomla.org/language/details/lv-LV_details.xml', ''),
(19, 3, 0, 0, 'Estonian', '', 'pkg_et-EE', 'package', '', 0, '2.5.7.1', '', 'http://update.joomla.org/language/details/et-EE_details.xml', ''),
(20, 3, 0, 0, 'Romanian', '', 'pkg_ro-RO', 'package', '', 0, '2.5.11.1', '', 'http://update.joomla.org/language/details/ro-RO_details.xml', ''),
(21, 3, 0, 0, 'Flemish', '', 'pkg_nl-BE', 'package', '', 0, '2.5.16.1', '', 'http://update.joomla.org/language/details/nl-BE_details.xml', ''),
(22, 3, 0, 0, 'Macedonian', '', 'pkg_mk-MK', 'package', '', 0, '2.5.13.1', '', 'http://update.joomla.org/language/details/mk-MK_details.xml', ''),
(23, 3, 0, 0, 'Japanese', '', 'pkg_ja-JP', 'package', '', 0, '2.5.16.1', '', 'http://update.joomla.org/language/details/ja-JP_details.xml', ''),
(24, 3, 0, 0, 'Serbian Latin', '', 'pkg_sr-YU', 'package', '', 0, '2.5.13.1', '', 'http://update.joomla.org/language/details/sr-YU_details.xml', ''),
(25, 3, 0, 0, 'Arabic Unitag', '', 'pkg_ar-AA', 'package', '', 0, '2.5.16.1', '', 'http://update.joomla.org/language/details/ar-AA_details.xml', ''),
(26, 3, 0, 0, 'German', '', 'pkg_de-DE', 'package', '', 0, '2.5.16.1', '', 'http://update.joomla.org/language/details/de-DE_details.xml', ''),
(27, 3, 0, 0, 'Norwegian Bokmal', '', 'pkg_nb-NO', 'package', '', 0, '2.5.16.1', '', 'http://update.joomla.org/language/details/nb-NO_details.xml', ''),
(28, 3, 0, 0, 'English AU', '', 'pkg_en-AU', 'package', '', 0, '2.5.10.1', '', 'http://update.joomla.org/language/details/en-AU_details.xml', ''),
(29, 3, 0, 0, 'English US', '', 'pkg_en-US', 'package', '', 0, '2.5.10.1', '', 'http://update.joomla.org/language/details/en-US_details.xml', ''),
(30, 3, 0, 0, 'Serbian Cyrillic', '', 'pkg_sr-RS', 'package', '', 0, '2.5.13.1', '', 'http://update.joomla.org/language/details/sr-RS_details.xml', ''),
(31, 3, 0, 0, 'Lithuanian', '', 'pkg_lt-LT', 'package', '', 0, '2.5.7.1', '', 'http://update.joomla.org/language/details/lt-LT_details.xml', ''),
(32, 3, 0, 0, 'Albanian', '', 'pkg_sq-AL', 'package', '', 0, '2.5.1.5', '', 'http://update.joomla.org/language/details/sq-AL_details.xml', ''),
(33, 3, 0, 0, 'Czech', '', 'pkg_cs-CZ', 'package', '', 0, '2.5.16.1', '', 'http://update.joomla.org/language/details/cs-CZ_details.xml', ''),
(34, 3, 0, 0, 'Persian', '', 'pkg_fa-IR', 'package', '', 0, '2.5.13.1', '', 'http://update.joomla.org/language/details/fa-IR_details.xml', ''),
(35, 3, 0, 0, 'Galician', '', 'pkg_gl-ES', 'package', '', 0, '2.5.7.4', '', 'http://update.joomla.org/language/details/gl-ES_details.xml', ''),
(36, 3, 0, 0, 'Polish', '', 'pkg_pl-PL', 'package', '', 0, '2.5.16.2', '', 'http://update.joomla.org/language/details/pl-PL_details.xml', ''),
(37, 3, 0, 0, 'Syriac', '', 'pkg_sy-IQ', 'package', '', 0, '2.5.10.1', '', 'http://update.joomla.org/language/details/sy-IQ_details.xml', ''),
(38, 3, 0, 0, 'Portuguese', '', 'pkg_pt-PT', 'package', '', 0, '2.5.8.1', '', 'http://update.joomla.org/language/details/pt-PT_details.xml', ''),
(39, 3, 0, 0, 'Russian', '', 'pkg_ru-RU', 'package', '', 0, '2.5.13.1', '', 'http://update.joomla.org/language/details/ru-RU_details.xml', ''),
(40, 3, 0, 0, 'Hebrew', '', 'pkg_he-IL', 'package', '', 0, '2.5.7.1', '', 'http://update.joomla.org/language/details/he-IL_details.xml', ''),
(41, 3, 0, 0, 'Catalan', '', 'pkg_ca-ES', 'package', '', 0, '2.5.16.1', '', 'http://update.joomla.org/language/details/ca-ES_details.xml', ''),
(42, 3, 0, 0, 'Laotian', '', 'pkg_lo-LA', 'package', '', 0, '2.5.6.1', '', 'http://update.joomla.org/language/details/lo-LA_details.xml', ''),
(43, 3, 0, 0, 'Afrikaans', '', 'pkg_af-ZA', 'package', '', 0, '2.5.14.1', '', 'http://update.joomla.org/language/details/af-ZA_details.xml', ''),
(44, 3, 0, 0, 'Chinese Simplified', '', 'pkg_zh-CN', 'package', '', 0, '2.5.14.1', '', 'http://update.joomla.org/language/details/zh-CN_details.xml', ''),
(45, 3, 0, 0, 'Greek', '', 'pkg_el-GR', 'package', '', 0, '2.5.6.1', '', 'http://update.joomla.org/language/details/el-GR_details.xml', ''),
(46, 3, 0, 0, 'Esperanto', '', 'pkg_eo-XX', 'package', '', 0, '2.5.6.1', '', 'http://update.joomla.org/language/details/eo-XX_details.xml', ''),
(47, 3, 0, 0, 'Finnish', '', 'pkg_fi-FI', 'package', '', 0, '2.5.13.1', '', 'http://update.joomla.org/language/details/fi-FI_details.xml', ''),
(48, 3, 0, 0, 'Portuguese Brazil', '', 'pkg_pt-BR', 'package', '', 0, '2.5.9.1', '', 'http://update.joomla.org/language/details/pt-BR_details.xml', ''),
(49, 3, 0, 0, 'Chinese Traditional', '', 'pkg_zh-TW', 'package', '', 0, '2.5.13.1', '', 'http://update.joomla.org/language/details/zh-TW_details.xml', ''),
...
(56, 3, 0, 0, 'Tamil India', '', 'pkg_ta-IN', 'package', '', 0, '2.5.16.1', '', 'http://update.joomla.org/language/details/ta-IN_details.xml', ''),
(57, 3, 0, 0, 'Scottish Gaelic', '', 'pkg_gd-GB', 'package', '', 0, '2.5.7.1', '', 'http://update.joomla.org/language/details/gd-GB_details.xml', ''),
(58, 3, 0, 0, 'Thai', '', 'pkg_th-TH', 'package', '', 0, '2.5.13.1', '', 'http://update.joomla.org/language/details/th-TH_details.xml', ''),
...
(64, 3, 0, 0, 'Swahili', '', 'pkg_sw-KE', 'package', '', 0, '2.5.16.1', '', 'http://update.joomla.org/language/details/sw-KE_details.xml', '');

-- --------------------------------------------------------

--
-- Структура таблицы `jykap_update_categories`
--

CREATE TABLE IF NOT EXISTS `jykap_update_categories` (
...
--
-- Структура таблицы `jykap_update_sites`
--

CREATE TABLE IF NOT EXISTS `jykap_update_sites` (
...
--
-- Дамп данных таблицы `jykap_update_sites`
--

INSERT INTO `jykap_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`) VALUES
(1, 'Joomla Core', 'collection', 'http://update.joomla.org/core/list.xml', 1, 1384327841),
(2, 'Joomla Extension Directory', 'collection', 'http://update.joomla.org/jed/list.xml', 1, 1384327841),
(3, 'Accredited Joomla! Translations', 'collection', 'http://update.joomla.org/language/translationlist.xml', 1, 1384327843);

-- --------------------------------------------------------

--
-- Структура таблицы `jykap_update_sites_extensions`
--

CREATE TABLE IF NOT EXISTS `jykap_update_sites_extensions` (
...
--
-- Дамп данных таблицы `jykap_update_sites_extensions`
--

INSERT INTO `jykap_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 600);
...
--
-- Структура таблицы `jykap_usergroups`
--

CREATE TABLE IF NOT EXISTS `jykap_usergroups` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
--
-- Дамп данных таблицы `jykap_usergroups`
--

INSERT INTO `jykap_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 20, 'Public'),
(2, 1, 6, 17, 'Registered'),
(3, 2, 7, 14, 'Author'),
(4, 3, 8, 11, 'Editor'),
...
--
-- Структура таблицы `jykap_users`
--

CREATE TABLE IF NOT EXISTS `jykap_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Дамп данных таблицы `jykap_users`
--

INSERT INTO `jykap_users` (`id`, `name`, `username`, `email`, `password`, `usertype`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`) VALUES
(467, 'Super User', 'admin', 'homework4@homework4.com', 'af124dea302109c5fa314b1d297584ff:KlQzlSmrplRrwgzycj7VbOFxxk8sXdnb', 'deprecated', 0, 1, '2013-11-11 09:15:36', '2013-11-13 07:30:39', '0', '', '0000-00-00 00:00:00', 0);

-- --------------------------------------------------------

--
-- Структура таблицы `jykap_user_notes`
--

CREATE TABLE IF NOT EXISTS `jykap_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Структура таблицы `jykap_user_profiles`
--

CREATE TABLE IF NOT EXISTS `jykap_user_profiles` (
...
--
-- Структура таблицы `jykap_user_usergroup_map`
--

CREATE TABLE IF NOT EXISTS `jykap_user_usergroup_map` (
...
--
-- Дамп данных таблицы `jykap_user_usergroup_map`
--

INSERT INTO `jykap_user_usergroup_map` (`user_id`, `group_id`) VALUES
(467, 8);

-- --------------------------------------------------------

--
-- Структура таблицы `jykap_viewlevels`
--

CREATE TABLE IF NOT EXISTS `jykap_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- Дамп данных таблицы `jykap_viewlevels`
--

INSERT INTO `jykap_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Структура таблицы `jykap_weblinks`
--

CREATE TABLE IF NOT EXISTS `jykap_weblinks` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `catid` int(11) NOT NULL DEFAULT '0',
